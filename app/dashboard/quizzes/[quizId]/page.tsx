...
import { getStudentQuizEnrolments } from "@/app/data/user/get-student-quiz-enrolments";
...
export default async function QuizDetailsPage({
  ...
  const [quiz, enrolments, submission] = await Promise.all([
    getStandaloneQuizDetails(quizId),
    getStudentQuizEnrolments(),
  ...
  const isEnrolled = enrolments.some((e) => e.quizId === quizId);
      ...
      <div className="order-1 lg:col-span-2 space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            {quiz.description ? (
              <div className="text-muted-foreground leading-relaxed [&_.prose]:text-muted-foreground">
